                                ...
                                <form action="{{ route('campaign.store') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            <h4 class="card-title float-start">Tambah Data Campaign</h4>
                                            <div class="float-end">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="form-check form-check-flat form-check-primary">
                                                                <label class="form-check-label">
                                                                    <input type="checkbox" class="form-check-input" id="toggleNominal"> Ceklis jika ingin menetapkan nominal
                                                                </label>
                                                            </div>
                                                        </div>
