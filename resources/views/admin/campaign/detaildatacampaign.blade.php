              ...
              <div class="card mb-5 shadow">
                <div class="card-body">
                  <a  id="toggleFilterButton" class="text-dark normal-link">
                    ...
                    <form action="{{ route('campaign.detaildatacampaign', encrypt($campaign->id)) }}" method="get" id="filterForm" class="{{ !$hasFilters ? 'd-none' : '' }}">
                      <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                          <div class="form-group row">
                              ...
                              <div class="form-group">
                                  <input type="text" class="form-control" name="order_id" id="order_id" value="{{ request('order_id') }}" placeholder="Cari Nominal Asli Sebelum dibagi 2%...">
                              </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card shadow">
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group">
                                        <h4 class="card-title float-start">Daftar Nama Alumni Yang Donasi ke Campaign {{ $campaign->nama }}</h4>
                                    </div>
                                </div>
                                <div class="row">
