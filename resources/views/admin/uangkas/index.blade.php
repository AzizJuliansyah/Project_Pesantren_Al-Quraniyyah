                            ...
                            <div class="form-group d-none" id="chartDonasi">
                                <div class="" style="max-height: 100%">
                                    <div class="form-group">
                                        <form action="/uangkas" method="get">
                                            <div class="row">
                                ...
                                @if(request()->has('month') || request()->has('year'))
                                    <div class="float-end me-3">
                                        <a href="{{ route('uangkas.index') }}"><i class="fa fa-arrow-left me-1"></i>Kembali</a>
                                    </div>
                                @endif      
                            </div>
                        </div>
                                    ...
                                    <div class="card card-rounded table-darkBGImg">
                                        <div class="card-body">
                                            <div class="col-sm-9">
                                                ...
                                                <a href="{{ route('detail.uangkas', $item['angkatan_id']) }}" class="btn btn-info upgrade-btn mt-3">Detail Keseluruhan <i class="fa fa-arrow-right ms-1"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
