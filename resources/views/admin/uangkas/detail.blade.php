    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
            <div class="content-wrapper">
                <div class="row">
                    <a href="/uangkas" class="mb-2"><i class="fa fa-arrow-left me-1"></i> Kembali</a>
                </div>
                <div class="row">
                                            ...
                                            <div class="col-lg-6 col-sm-12" style="white-space: nowrap;">
                                                <div class="float-start">
                                                    <div class="form-group">
                                                        <form action="/uangkas/detail/{{ $angkatan_id }}" method="get">
                                                    ...
                                                    <div class="float-end me-1">
                                                        <a href="{{ route('detail.uangkas', $angkatan_id) }}"><i class="fa fa-arrow-left me-1"></i>Kembali</a>
                                                    </div>
                                                    @endif
                                            </div>
                                        </div>
