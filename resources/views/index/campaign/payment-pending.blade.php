                ...
                <div class="donation-card p-0">
                    ...
                    <div class="card  py-5 px-4 px-sm-5 shadow">
                        <div class="card-body p-0">
                            <h5 class="text-center text-warning mt-3"><strong>Informasi Pembayaran Tertunda</strong></h5>
                            <div class="brand-logo text-center mt-3">
                                <img src="{{ asset('assets/images/pending.png') }}" alt="logo" style="width: 60px;">
                                <h2 class="text-warning mt-1">PENDING</h2>
                                <h6 class="text-warning">Pembayaran Donasi Tertunda</h6>
                            </div>
                            <div class="row">
                                <small class="text-muted mb-2">Anda melakukan pembayaran di program:</small>
                            ...
                            <div class="form-group mt-3">
                                <div class="row">
                                    ...
                                    <h5 class="text-center text-warning mt-3"><strong>Pembayaran Tetunda</strong></h5>
                                </div>
                            </div>
                            ...
                            <div class="d-grid">
                                <button class="btn btn-warning btn-md col-12 shadow" id="pay-button">Bayar Sekarang</button>
