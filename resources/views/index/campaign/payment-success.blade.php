                ...
                <div class="donation-card p-0">
                    ...
                    <div class="card  py-5 px-4 px-sm-5 shadow">
                        <div class="card-body p-0">
                            <h5 class="text-center text-success mt-3"><strong>Pembayaran Berhasil dilakukan</strong></h5>
                            ...
                            <div class="row">
                                <small class="text-muted mb-2">Anda berhasil melakukan pembayaran di program:</small>
                            ...
                            <div class="form-group mt-3">
                                ...
                                <div class="order-id-payment-success">
                            ...
                            <div class="form-group mt-3">
                                <div class="row">
                                    ...
                                    <div class="d-grid">
                                        <div class="payment-success mt-3">
                                    ...
                                    <h5 class="text-center text-success mt-3">Pembayaran Berhasil dilakukan</h5>
                                </div>
                            </div>
                            ...
                            <div class="d-grid">
                                <a href="/" class="btn btn-success btn-md col-12 shadow">Kembali ke home</a>
