                ...
                <div class="donation-card p-0">
                    ...
                    <div class="card  py-5 px-4 px-sm-5 shadow">
                        <div class="card-body p-0">
                            <h5 class="text-center text-danger mt-3"><strong>Pembayaran Gagal dilakukan</strong></h5>
                            <div class="brand-logo text-center mt-3">
                                <img src="{{ asset('assets/images/error.png') }}" alt="logo" style="width: 60px;">
                                <h2 class="text-danger mt-1">ERROR</h2>
                                <h6 class="text-danger">Pembayaran Donasi Gagal</h6>
                            </div>
                            <div class="row">
                                <small class="text-muted mb-2">Anda gagal melakukan pembayaran di program:</small>
                            ...
                            <div class="form-group mt-3">
                                ...
                                <div class="order-id-payment-error">
                            ...
                            <div class="form-group mt-3">
                                <div class="row">
                                    ...
                                    <h5 class="text-center text-danger mt-3">Pembayaran Gagal dilakukan</h5>
                                </div>
                            </div>
                            ...
                            <div class="d-grid">
                                <a href="/" class="btn btn-danger btn-md col-12 shadow">Kembali ke home</a>
